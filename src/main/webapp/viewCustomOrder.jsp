...
<%
  ...
  for (Order o : AdminOrderService.getAllCustomOrders()) {
...
<div class="details-container">
  <h3 class="details-title">Custom Order Details</h3>
  ...
  <div class="mb-3"><span class="info-label">Contact:</span> <%= foundOrder.getContact() %></div>
  <div class="mb-3"><span class="info-label">Nationality:</span> <%= foundOrder.getNationality() %></div>
  ...
  <div class="mb-3"><span class="info-label">Country:</span> <%= foundOrder.getCountry() %></div>
  <div class="mb-3"><span class="info-label">Message:</span> <%= foundOrder.getMessage() %></div>
  ...
  <a href="manageCustomOrders.jsp" class="btn btn-outline-secondary btn-back">
    <i class="bi bi-arrow-left"></i> Back to Custom Orders
  </a>
</div>
